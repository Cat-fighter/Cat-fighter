...
function showCats() {
  ...
  for (let i in state.catList.cat) {
    ...
    information.textContent = `Name: ${state.catList.cat[i].name}, HP: ${state.catList.cat[i].hp}, DEF: ${state.catList.cat[i].def}, ATT: ${state.catList.cat[i].att}, Class: ${state.catList.cat[i].style} `;
